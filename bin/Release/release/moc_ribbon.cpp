...
#include <memory>
#include "../../../Extern/QT-Ribbon-Widget/inc/ribbon.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Ribbon_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_Ribbon_t qt_meta_stringdata_Ribbon = {
    {
        QT_MOC_LITERAL(0, 6)   // "Ribbon"
    },
    "Ribbon"
};
...
const QMetaObject Ribbon::staticMetaObject = { {
    ...
    qt_meta_stringdata_Ribbon.offsetsAndSizes,
    qt_meta_data_Ribbon,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Ribbon_t
, QtPrivate::TypeAndForceComplete<Ribbon, std::true_type>
